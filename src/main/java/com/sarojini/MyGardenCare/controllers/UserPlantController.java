...
@Tag(name = "User's Garden Plants",
        description = "Endpoints for users to get, add and update the plants in their garden")
...
public class UserPlantController {
    ...
    @Operation(summary = "Get all plants in a user's garden",
    description = "Get a list of all the plants the current user has. If they have none, an empty list will be returned.",
    responses = {
            @ApiResponse(responseCode = "200", description = "User's plants found and returned"),
    ...
    @Operation(summary = "Get a specific plant by name",
    description = """
    ...
    """,
    responses = {
            @ApiResponse(responseCode =  "200", description = "Plant found and returned"),
    ...
    @Operation(summary = "Add a new plant to the user's garden",
            description = """
                    ...
                    """,
            responses = {
                    @ApiResponse(responseCode = "201", description = "New plant added to user's garden"),
                    @ApiResponse(responseCode = "409", description = "User already has this plant"),
    ...
    public ResponseEntity<UserPlantResponse> createUserPlant(@AuthenticationPrincipal User user,
                                                             @io.swagger.v3.oas.annotations.parameters.RequestBody(
                                                                     description = "New plant to add to user's garden",
                                                                     required = true
                                                             )
    ...
    responses = {
        ...
        @ApiResponse(responseCode = "400", description = "Patch request was not well formed"),
        @ApiResponse(responseCode = "403", description = "Logic rule violated"),
        @ApiResponse(responseCode = "409", description = "User already has this plant"),
        @ApiResponse(responseCode = "401", description = "Unauthorized request, missing or invalid JWT")
    })
    @PatchMapping("/{id}")
    public ResponseEntity<UserPlantResponse> updateUserPlantById(@PathVariable Long id,
                                                                 ...
                                                                 @io.swagger.v3.oas.annotations.parameters.RequestBody(
                                                                         description = "Partial updates to an existing plant",
                                                                         required = true
                                                                 )
